...
export interface TechListSliceDefaultPrimaryTechitemItem {
	 ...
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: tech_list.default.primary.techitem[].tech_name
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	 ...
	 * - **Field Type**: Color
	 * - **Placeholder**: *None*
	 * - **API ID Path**: tech_list.default.primary.techitem[].tech_color
...
export interface TechListSliceDefaultPrimary {
	 ...
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: tech_list.default.primary.techitem[]
	 * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
	 */
	techitem: prismic.GroupField<Simplify<TechListSliceDefaultPrimaryTechitemItem>>;
}
